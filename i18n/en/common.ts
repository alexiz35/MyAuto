export default {
  ...
  carInfo: {
    ...
    BUTTON_CURRENCY: 'Currency - {{currency}}',
    RESET_TO: 'Reset',
    modalNameCar: {
  ...
  inputService: {
    ...
    REMINDER: 'Create \nReminder',
    ADD_PARTS: 'Add Parts',
    ADD_SUM: 'Added: {{amountPart}} $t(PCS) for a total of {{sumCost}} {{currency}}',
  ...
  statScreen: {
    ...
    FUEL_COST: 'for {{fuel_cost}} {{currency}}',
    FUEL_AVERAGE: 'Average consumption, $t(CONSUMPTION)',
    PARTS_COSTS: 'Spent on parts, {{currency}}',
    SERVICE_COSTS: 'Spent on services, {{currency}}',
    OTHER_COSTS: 'Spent on another, {{currency}}',
    ALL: 'All',
    FUEL: 'Fuel',
    PART: 'Parts',
    OTHER: 'Other',
  ...
  pdfCard: {
    ...
    FILE_SAVED_ERROR: 'The file was not saved'
  },
  docsPanel: {
