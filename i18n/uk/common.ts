export default {
  ...
  inputService: {
    ...
    ADD_SUM: 'Додано: {{amountPart}} $t(PCS) на загальну суму {{sumCost}} $t(CURRENCY)',
  ...
  statScreen: {
    ...
    PARTS_COSTS: 'Вартість запчастин, $t(CURRENCY)',
    SERVICE_COSTS: 'Вартість робіт, $t(CURRENCY)',
    OTHER_COSTS: 'Витрати на інше, $t(CURRENCY)',
    ALL: 'Все',
    FUEL: 'Пальне',
    PART: 'Запчастини',
    OTHER: 'Інше',
