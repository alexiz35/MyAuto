export default {
  ...
  premium: {
    TITLE: 'Повний доступ',
    ALERT_TITLE: 'Додатковий функціонал у розширеній версії',
    ALERT_MESSAGE: 'Застосунок DevizCar зараз перебуває в активній фазі налагодження, тому поки що повний ' +
      'функціонал доступний усім користувачам, без винятку.' +
      ' Ви можете підтримати проект своїм активним тестуванням, пропозиціями та відгуками.' +
      ' Найактивніші учасники тестування будуть винагороджені надалі безкоштовним доступом до преміум' +
      ' функцій застосунку.' +
      '\n І, звичайно, ви можете підтримати проект філіжанкою кави для наших розробників.' +
      ' Підтримавши нас зараз, ви автоматично отримаєте повний доступ до всіх функцій застосунку.' +
      '\n З найкращими побажаннями, команда DevizCar',
    ALERT_BUTTON_REVIEW: 'Відгук',
    ALERT_BUTTON_CANCEL: 'Відмінити',
    ALERT_BUTTON_DONAT: 'Підтримати',
    CARD_TITLE: 'Отримай доступ до унікальних функцій DevizCar',
    LIST_FUNCTION_1: 'Облік 2-х та більше авто',
    ...
    alertAccess: {
      TITLE: 'Функція доступна за умови рівня доступу - {{levelAccess}}',
  ...
  pdfCard: {
    ...
    SERVICE: 'Виконані роботи',
    PART: 'Купівля запчастин',
    OTHER: 'Інші витрати',
    FUEL: 'Заправки',
